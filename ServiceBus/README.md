...
3. You need to provide the resource group name of the Azure Automation account you've created in step 1 (so choose existing) and the Automation Account name. Please also provide an unique Job Guid.
